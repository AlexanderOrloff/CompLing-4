...
#сделал несколько minor changes  к файлу, но первую домашку я загрузил вовремя!
#in collaboration with happy puffin
...
results = search_elmo('введи слово', elmo_vectors, sess, batcher, sentence_character_ids, elmo_sentence_input)
